...
#ifndef myExamplePlugin_541811462_h
#define myExamplePlugin_541811462_h
...
#define MySturctPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define MySturctPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define MySturctPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define MySturctPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define MySturctPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern MySturct*
MySturctPluginSupport_create_data_w_params(
    const struct DDS_TypeAllocationParams_t * alloc_params);

NDDSUSERDllExport extern MySturct*
MySturctPluginSupport_create_data_ex(RTIBool allocate_pointers);
...
MySturctPluginSupport_destroy_data_w_params(
    MySturct *sample,
    const struct DDS_TypeDeallocationParams_t * dealloc_params);

NDDSUSERDllExport extern void 
MySturctPluginSupport_destroy_data_ex(
    MySturct *sample,RTIBool deallocate_pointers);
...
NDDSUSERDllExport extern void 
MySturctPluginSupport_print_data(
...
NDDSUSERDllExport extern RTIBool 
MySturctPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    MySturct * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
MySturctPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    MySturct ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
MySturctPlugin_new(void);

NDDSUSERDllExport extern void
MySturctPlugin_delete(struct PRESTypePlugin *);
...
#endif /* myExamplePlugin_541811462_h */
